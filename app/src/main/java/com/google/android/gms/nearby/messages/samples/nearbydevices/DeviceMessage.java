...
public class DeviceMessage {
     ...
     */
    public static Message newNearbyMessage(String instanceId, String eventname) {
        DeviceMessage deviceMessage = new DeviceMessage(instanceId, eventname);
    ...
    private DeviceMessage(String uuid, String message) {
        mUUID = uuid;
